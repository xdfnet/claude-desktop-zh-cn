...
| 🌐 日期 locale 映射 | 找到 `const uze={"en-US":"en",…}` 对象，追加 `"zh-CN":"zh"` |
...
├── zh-CN-app.json          Claude 1.15962.0 简体中文翻译（17,316 条，90% 覆盖，应用内 UI 层）
├── zh-CN-shell.json        Claude 1.15962.0 简体中文翻译（430 条，100% 覆盖，原生 Shell 层）
